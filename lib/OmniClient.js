...
var OmniClientCommands = {
    ...
    omniListBlocksTransactions: 'omni_listblockstransactions',
    ...
    omniFundedSendAll: 'omni_funded_sendall',
    omniFundedSend: 'omni_funded_send',
    omniGetWalletAddressBalances:'omni_getwalletaddressbalances',
...
Omni.getorderbook = function (id1, id2, cb) {
    if (id2 == null) {
        ...
        client.cmd("omni_getorderbook", id1, id2, function (err, data, resHeaders) {
            if (err) {
                console.log(err)
            }
...
Omni.gettradehistoryaddress = function (address, trades, propertyfilter, cb) {
    ...
    if (propertyfilter == null) {
        ...
        client.cmd("omni_gettradehistoryforaddress", address, trades, propertyfilter, function (err, data, resHeaders) {
            return cb(data)
        })
    }
}
